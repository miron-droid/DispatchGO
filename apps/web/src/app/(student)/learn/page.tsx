      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          <p className="text-sm text-gray-400">
            {t('learn_hello')}, <span className="text-gray-600 font-medium">{user?.firstName}</span> 👋
          </p>
          <h1 className="text-xl lg:text-2xl font-bold text-gray-900 mt-0.5 tracking-tight">
