          ...
          <div key={exam.id} className="card">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-400">{translateTitle(exam.chapter?.title ?? '')}</p>
              </div>
            ...
            {reviewing === exam.id ? (
              <div className="space-y-3 pt-2 border-t border-gray-100">
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          decision === d.value ? d.color : 'border-gray-200 text-gray-400 hover:border-gray-300',
                        )}
                      >
                ...
                <div className="flex gap-2">
                  ...
                  <button className="btn-ghost border border-gray-200 px-4" onClick={() => { setReviewing(null); setComment(''); }}>
