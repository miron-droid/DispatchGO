    ...
    return (
      <div className="mt-6 card p-6 bg-gray-900 text-white border-0 space-y-4">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between"><span className="text-gray-400">{lang === 'ru' ? 'Приоритизация' : 'Triage'}</span><span>{triageScore}/30</span></div>
          <div className="flex justify-between"><span className="text-gray-400">{lang === 'ru' ? 'Решения' : 'Decisions'}</span><span>{decisionScore}/50</span></div>
          <div className="flex justify-between"><span className="text-gray-400">{lang === 'ru' ? 'Скорость' : 'Speed'}</span><span>{timeScore}/20</span></div>
        </div>
