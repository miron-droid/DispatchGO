...
export interface TextContent    { type: 'text'; body: string; bodyRu?: string; quiz?: { questions: QuizQuestion[] }; quizRu?: { questions: QuizQuestion[] }; simulation?: boolean; freightMap?: boolean; equipmentMatcher?: boolean; phoneCall?: boolean; driverChat?: boolean; loadBoard?: boolean; negotiationGame?: boolean; crisisDashboard?: boolean }
