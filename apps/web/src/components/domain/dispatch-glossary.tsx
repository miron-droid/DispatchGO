    ...
    <div>
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          className="w-full pl-9 pr-9 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-200 bg-gray-50 text-gray-800 placeholder-gray-400"
        />
        {search && (
          <button
            onClick={() => setSearch('')}
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between px-4 py-3 gap-3">
                        ...
                        <span className={cn(
                          'text-gray-300 text-sm shrink-0 transition-transform duration-200',
                          isOpen && 'rotate-180'
                        )}>▾</span>
                      </div>
