...
const MARKET_CFG = {
  ...
  neutral: { en: 'Neutral Market', ru: 'Нейтральный',     cardEn: 'Neutral', cardRu: 'Нейтр.',   color: 'bg-gray-100 text-gray-600 border-gray-200',    dot: 'bg-gray-400'   },
...
export function StateFreightDictionary() {
  ...
  return (
    <div className="mt-8 mb-4 rounded-2xl border border-gray-100 bg-white shadow-sm overflow-hidden">
      {/* Header */}
      ...
      {/* Filters */}
      <div className="px-4 py-4 lg:px-6 border-b border-gray-100 space-y-3">
        {/* Search */}
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-slate-300 bg-gray-50 text-gray-800 placeholder-gray-400"
          />
          {search && (
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={cn('px-3 py-1.5 rounded-lg text-xs font-medium border transition-all',
              region === 'All' ? 'bg-slate-800 text-white border-slate-800' : 'bg-white text-gray-600 border-gray-200 hover:border-slate-400'
            )}
          >
          ...
          {REGIONS.map(r => (
            <button
              ...
              onClick={() => setRegion(r)}
              className={cn('px-3 py-1.5 rounded-lg text-xs font-medium border transition-all',
                region === r ? 'bg-slate-800 text-white border-slate-800' : 'bg-white text-gray-600 border-gray-200 hover:border-slate-400'
              )}
            >
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={cn('px-3 py-1.5 rounded-lg text-xs font-medium border transition-all',
              market === 'All' ? 'bg-slate-800 text-white border-slate-800' : 'bg-white text-gray-600 border-gray-200 hover:border-slate-400'
            )}
          >
          ...
          {(['hot', 'warm', 'neutral', 'cold'] as Market[]).map(m => (
            <button
              ...
              onClick={() => setMarket(m)}
              className={cn('px-3 py-1.5 rounded-lg text-xs font-medium border transition-all',
                market === m ? MARKET_CFG[m].color + ' font-bold' : 'bg-white text-gray-600 border-gray-200 hover:border-gray-400'
              )}
            >
        ...
        <div className="mx-4 my-4 lg:mx-6 rounded-2xl border-2 border-slate-200 bg-slate-50 p-4 lg:p-6 animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="flex items-start justify-between gap-4 mb-4">
            ...
            <button
              ...
              className="text-gray-400 hover:text-gray-700 text-xl font-bold shrink-0"
            >✕</button>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 px-4 py-3 mb-4 flex items-center gap-4">
            <div>
              <p className="text-xs text-gray-500 mb-0.5">{ru ? 'Диапазон RPM (2026)' : 'RPM Range (2026)'}</p>
            ...
            <div>
              <p className="text-xs text-gray-500 mb-0.5">{ru ? 'Средний RPM' : 'Avg RPM'}</p>
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              {(ru ? selectedState.freightRu : selectedState.freight).map((f, i) => (
                <span key={i} className="px-2.5 py-1 rounded-lg bg-white border border-gray-200 text-xs text-gray-700 font-medium">
                  📦 {f}
                </span>
              ))}
            </div>
            ...
            {filtered.map(s => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs text-gray-600 font-medium leading-tight mb-2">
                    {ru ? s.nameRu : s.name}
                  </p>
      ...
      {/* Footer */}
      <div className="border-t border-gray-100 px-4 py-3 lg:px-6 bg-gray-50">
